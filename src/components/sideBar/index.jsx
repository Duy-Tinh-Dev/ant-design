...
import "./sidebar.css";
import { Checkbox, Button ,Slider, Switch ,Menu ,Input ,Popover , Segmented} from 'antd';
...
function SideBarTest() {
  ...
  function Cpn_sideBar_header() {
    ...
    const data_content_apt= ['Tư vấn hợp đồng bảo hiểm','Ký hợp đồng','Sinh nhật','Kí hợp đồng'];
    ...
    function Cpn_check_box() {
      return(
        ...
        <div className="sb_filter">
          <h3 style={{padding: '0 0 10px 0',borderBottom : '1px solid rgb(173 173 173)'}}>Nội dung cuộc hẹn</h3>
          <CheckboxGroup 
    ...
    return (
      <div className="sb_sideBar_header">
          ...
          <div style={{width : '30%'}}>
            <div>
              <h3 style={{fontWeight : 'bold' , color : 'var(--color-button)'}}>Hoàn thành {val_scs}/64</h3>
            </div>
            <Slider min={0} max={64} defaultValue={64} value={val_scs} onChange={(e) => onChange(e)}/>
          </div>

          <div style={{borderRadius : '20px',padding : '0 20px',display : 'flex', justifyContent : 'center',backgroundColor: 'rgb(240 242 245)'}}>
            <Popover
            ...
            >
                <h3 style={{margin : 'auto 0'}}>
                  <span style={{color: 'white',margin : '0 10px 0 0',padding: '5px 10px', borderRadius : '30px' ,backgroundColor : 'rgb(246 208 75)'}}>1</span>
                  Bộ lọc
                  <i style={{margin : '0 0 0 20px'}} class="fa-solid fa-filter"></i>
                </h3>
            </Popover>
          </div>
  ...
  function Cpn_sb_cal_week() {
    return (
      <div className="sb_cal_week">
        ...
        <Segmented style={{width: '100%', padding: '10px', borderRadius : '20px'}} options={['Thứ 2', 'Thứ3', 'Thứ 4', 'Thứ 5', 'Thứ 6', 'Thứ 7', "CN"]} />
      </div>
    )
  }
          ...
          {data_sb_content.map((tmp) => {
            return (
              ...
              style={{
                ...
                <div className="sb_intro" style={{padding : '0 20px',width: '100%'}}>
                    <div style={{display : 'flex', alignItems : 'center'}}>
                      <i class="fa-solid fa-building sb_i_company" style={{fontSize : '20px', margin : '0 20px 0 0'}}></i>
                      <div>
                    ...
                    <div style={{display : 'flex', alignItems : 'center'}}>
                      <i style={{fontSize : '25px'}} class="fa-regular fa-square-check"></i>
                    </div>
                </div>
